...
- **THEN** Loja, Torrefação, Nossa História, and Unidades links are visible
...
- **WHEN** Footer renders
- **THEN** Política de Privacidade, Termos de Serviço, Contato, and Atacado links are visible

#### Scenario: Copyright text rendered
- **WHEN** Footer renders
- **THEN** the Portuguese copyright notice is visible
